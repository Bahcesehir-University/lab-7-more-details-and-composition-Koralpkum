...
public:
    ...
    Point(double x, double y) : x(x), y(y) {}  // stub — fix initializer //BİTTİ

    // TODO 2: const getter for x
    double getX() const { return x; }   // stub — add const //BİTTİ

    // TODO 3: const getter for y
    double getY() const { return y; }   // stub — add const //BİTTİ

    // TODO 4: const display()
    void display() const { std::cout << "("<<x<<", "<<y<<")"; } //BİTTİ

    // TODO 5: declare Rectangle as friend class
    
    friend class Rectangle; //FİNİTO
};
...
bool isSameSize(const Rectangle& r1, const Rectangle& r2) {
    return r1.getArea() == r2.getArea();  // stub  //BURAYA BAK
}
...
public:
    ...
    int getValue() const { return value; }  // stub — add const //BİTTİ

    // TODO 15: NON-const doubleValue() — multiplies value by 2 /BİTTİ
    void doubleValue() { value=2*value; }  // stub
